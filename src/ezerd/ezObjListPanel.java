 ...
 * @author CMC
 */
public class ezObjListPanel extends Panel{
    ezObjList ObjList;
    int ObjID;
    Label ObjIDLabel,ObjHorDLabel;
    TextField IndexTextField;
    String HideS,DisplayS;
    ezObjListPanel(ezObjList p,int ID){
        super();
        ObjList=p;
        ObjID=ID;
        HideS="hide";
        ...
        this.addMouseListener(new MouseAdapter(){
            ...
            public void mousePressed(MouseEvent e){
                for (ezObj o : ObjList.AtoolBar.parent.WorkSpace.activePage.Objs) {     
                    if (o.ID == ObjID) {
        ...
        ObjHorDLabel.setFont(new ezFont());
