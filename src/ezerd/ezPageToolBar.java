 ...
 * @author CMC
 */
public class ezPageToolBar extends Panel{
    ...
    void addBtton(int n,String s){    
        ...
        Btns.elementAt(n).addKeyListener(new ezKeyListener(WorkSpace.parent));/**/
        allPage();
        resetPageMenu();
    ...
    void updatePage(int n){
        ezPage ep =WorkSpace.Pages.elementAt(n);
    ...
    void resetPageMenu(){
        ...
        for(i=0;i<BtnJ.size();i++){
            if(!BtnJ.elementAt(i)){
                ezPageMenuItem temp=new ezPageMenuItem(Btns.elementAt(i).getText(),i);
                temp.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ...
                        resetButtonSize();
                        allPage();
                        ezPageToolBar.this.resetPageMenu();
                    }
                });
