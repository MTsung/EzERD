 ...
 * @author CMC
 */
public class ezObjAttributesPanel extends Panel{
    ...
    ezObjAttributesPanel(ezAttributesToolBar p){
        super();
        AtoolBar=p;
        ...
        LabelX.setFont(new ezFont());
        LabelY.setFont(new ezFont());
        LabelTra.setFont(new ezFont());
        LabelAngle.setFont(new ezFont());
        LabelLineColor.setFont(new ezFont());
        LabelBGColor.setFont(new ezFont());
        Labelsize.setFont(new ezFont());
        LabelLine.setFont(new ezFont());
        LabelTextColor.setFont(new ezFont());
