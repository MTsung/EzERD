 ...
 * @author CMC
 */
public class ezColorTextPanel extends Panel{
    ezAttributesToolBar AttributesToolBox;
    TextField[] TextRGB=new TextField[3];
    TextField[] TextHSB=new TextField[3];
    Panel TextPanel,ColorPanel,TempPanel1,TempPanel2;
    ezColorTextPanel(ezAttributesToolBar p){
        super();
        AttributesToolBox=p;
        TextPanel=new Panel();
        ...
        for(Component a:this.getComponents())/**/
            a.addKeyListener(new ezKeyListener(AttributesToolBox.parent));/**/
        this.addKeyListener(new ezKeyListener(AttributesToolBox.parent));/**/
    }
